package com.shaibal.meetings.constants;

public class ResponseConstants {
    public static final String DELETE_MEETING_RESPONSE = "deleteMeetingResponse";
    public static final String ATTEND_MEETING_RESPONSE = "attendMeetingResponse";
